  ...
  return (
    <div className='nosotros'>
      <section className='nosotros-text'>
        ...
        <p>
            Somos reconocidos por nuestra calidad, además nos basamos en un grupo humano altamente calificado, con  una búsqueda constante de desarrollo profesional y personal, que mantiene una relación de crecimiento mutuo con la empresa. la solidez del equipo esta forjada por el compromiso, los conocimientos y las habilidades de cada uno de sus miembros.
        </p>
      </section>
      <section className='nosotros-img'>
